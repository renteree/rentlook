...
export default defineMessages({
  catalog: {
    id: 'SideBar.SideBar.catalog',
    defaultMessage: 'Catalog',
    description: 'Title for the page header',
  },
  notFound: {
    id: 'SideBar.SideBar.notFound',
    defaultMessage: 'Not Found',
    description: 'Title for the page header',
  },
  newRenter: {
    id: 'SideBar.SideBar.newRenter',
    defaultMessage: 'Create a new ad',
    description: 'Title for the page header',
  },
  renter: {
    id: 'SideBar.SideBar.renter',
    defaultMessage: 'Renter',
  },
  renteree: {
    id: 'SideBar.SideBar.renteree',
    defaultMessage: 'Renteree',
    description: 'If no page was found',
  },
  projectDescription: {
  ...
  projectFirstStep: {
    id: 'SideBar.SideBar.projectFirstStep',
  ...
  projectSecondStep: {
    id: 'SideBar.SideBar.projectSecondStep',
